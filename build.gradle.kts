...
tasks.register("developerDocs") {
    ...
    dependsOn(
        ...
        ":awake:engine:platform-authoring:dokkaGeneratePublicationHtml",
        ":awake:engine:platform-authoring:desktopTest",
        ":awake:engine:platform-authoring:gameDslTutorialDocsReport",
        ":awake:engine:platform-authoring:uiDslTutorialDocsReport",
