...
| `awake:engine:game-dsl` | Dokka | Partial | `samples:hello-cube` authored bootstrap proof | In progress | Expand `game {}` cookbook and installer patterns |
| `awake:engine:ui-dsl` | Dokka | Partial | UI DSL tutorial snapshots | In progress | Expand authored UI cookbook and custom component examples |
