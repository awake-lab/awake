...
private val expectedShowcaseLayoutSignatures = mapOf(
    "ui-showcase-overview" to 0xb673bc9bb6149e1duL,
    "ui-showcase-theming" to 0xb78c7a6b74453b5auL,
    "ui-showcase-typography" to 0x73cc95ffbd295d42uL,
    ...
    "ui-showcase-card" to 0xff4a282769b6b5a4uL,
    "ui-showcase-sidebar" to 0x7b873256c3c67de5uL,
    "ui-showcase-selection" to 0x9851f324c711f52fuL,
    "ui-showcase-range-slider" to 0xb673bc9bb6149e1duL,
    ...
    "ui-showcase-alert" to 0x8f9e41200120ca11uL,
    "ui-showcase-text-input" to 0xba6c8030fad27874uL,
    "ui-showcase-popups" to 0x002e01bc254488b7uL,
    "ui-showcase-state" to 0xb673bc9bb6149e1duL,
    "ui-showcase-button-matrix" to 0xeb99998df754bcc9uL,
    "ui-showcase-field-matrix" to 0xd50c39a857cbcc0auL,
    "ui-showcase-slider-matrix" to 0x081cab0941278ca9uL,
    ...
    "ui-showcase-shimmer" to 0xb673bc9bb6149e1duL,
    "ui-showcase-collapsible" to 0xeb94b634c244b64cuL,
    "ui-showcase-collapsible-open" to 0x7f286dd9db6f7592uL,
    "ui-showcase-field-demo" to 0xb673bc9bb6149e1duL,
)
