 ...
 * computable regardless of [AppUiRuntime.perfStatsEnabled]/[AppUiRuntime.debugOverlayEnabled];
 * [trialPasses] just reads `0` when [UiMeasureTrialStats]
 * tracking isn't enabled, since nothing incremented it that frame.
 */
data class AppFrameStats(
...
fun AppUiRuntime.frameStats(): AppFrameStats {
 ...
 */
internal fun AppUiRuntime.drawPerfStatsOverlay() {
