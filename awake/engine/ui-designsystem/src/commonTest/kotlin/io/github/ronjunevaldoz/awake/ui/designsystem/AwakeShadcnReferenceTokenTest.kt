...
/**
 * Diffs [AwakeShadcnTheme]'s resolved colors against the *real* shadcn reference -- not our
 ...
 */
class AwakeShadcnReferenceTokenTest {
    ...
    fun defaultDarkPrimaryMatchesRealShadcnOklch() {
        ...
        val actual = awakeShadcnTheme(dark = true).tokens.primary
    ...
    fun defaultLightPrimaryMatchesRealShadcnOklch() {
        ...
        val actual = awakeShadcnTheme(dark = false).tokens.primary
    ...
    fun defaultDarkDestructiveMatchesRealShadcnOklch() {
        ...
        val actual = awakeShadcnTheme(dark = true).tokens.destructive
    ...
    fun defaultLightDestructiveMatchesRealShadcnOklch() {
        ...
        val actual = awakeShadcnTheme(dark = false).tokens.destructive
    ...
    fun focusRingStaysAMidGrayLikeRealShadcnRingToken() {
        ...
        // color family deliberately zeroes chroma (see AwakeShadcnBaseColor.Neutral), so
        ...
        assertColorClose("dark ring", darkReference, awakeShadcnTheme(dark = true).asAwakeShadcnTheme().ring, tolerance = 0.08f)
        assertColorClose("light ring", lightReference, awakeShadcnTheme(dark = false).asAwakeShadcnTheme().ring, tolerance = 0.08f)
    }
