...
// Turns build/ui-snapshots/*.png (written unconditionally by any test using
// snapshot.saveUiSnapshot(), pass or fail -- see that function's doc comment) into one
// self-contained HTML gallery, same "base64-inline, single file" shape as
// awake:backend:vulkan's pixelBaselineReport, but always regenerated regardless of test
// outcome -- this is a design-review aid (is this theme/variant/state legible), not a
// pass/fail artifact.
