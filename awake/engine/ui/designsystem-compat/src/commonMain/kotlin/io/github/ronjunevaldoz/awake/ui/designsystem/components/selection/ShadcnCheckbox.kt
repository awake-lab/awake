...
@Deprecated(
    message = "Use the Headless UiScope shadcnCheckbox overload; Core receivers are a migration bridge.",
    replaceWith = ReplaceWith("shadcnCheckbox(id, checked, label, modifier, indeterminate, enabled)"),
)
