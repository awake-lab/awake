...
import io.github.ronjunevaldoz.awake.ui.headless.toast as headlessToast
...
fun HeadlessUiScope.shadcnToast(
    id: String,
    message: String,
    modifier: HeadlessModifier = HeadlessModifier,
    durationMs: Float = 3000f,
): Boolean = headlessToast(
    id = id,
    message = message,
    modifier = modifier,
    durationMs = durationMs,
