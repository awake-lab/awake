 ...
 * [toggleSlot]. */
@Deprecated(
    message = "Use the Headless UiScope shadcnToggle overload; Core receivers are a migration bridge.",
    replaceWith = ReplaceWith("shadcnToggle(id, checked, modifier, enabled, variant, onCheckedChange, content)"),
)
...
@Deprecated(
    message = "Use the Headless UiScope shadcnToggle overload; Core receivers are a migration bridge.",
    replaceWith = ReplaceWith("shadcnToggle(id, checked, modifier, enabled, variant, onCheckedChange, label)"),
)
fun UiScope.shadcnToggle(
    id: String,
    checked: Boolean,
