...
import io.github.ronjunevaldoz.awake.ui.headless.contextMenuTrigger as headlessContextMenuTrigger
...
/** Context-menu facade using Headless secondary-click behavior and popup selection. */
fun HeadlessUiScope.shadcnContextMenu(
    id: String,
    expanded: Boolean,
    onExpandedChange: (Boolean) -> Unit,
    items: List<UiDropdownMenuEntry>,
    target: HeadlessUiScope.() -> UiBounds,
): UiBounds {
    val bounds = target()
    val trigger = headlessContextMenuTrigger(id, expanded, bounds)
