 ...
 * -- same per-widget elapsed-time accumulation as [io.github.ronjunevaldoz.awake.ui.headless.internal.input.text.textField]'s caret blink (`caretBlinkElapsedSeconds`),
