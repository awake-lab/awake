...
internal fun shadcnCollapsibleTriggerStyle(values: UiThemeValues): Style = Style {
...
internal fun shadcnCollapsibleTitleStyle(values: UiThemeValues): Style = Style {
    textSize(values.typography.body)
}

internal fun shadcnCollapsibleCardStyle(values: UiThemeValues): Style = Style {
...
internal fun shadcnTabsTrackStyle(values: UiThemeValues): Style = Style {
    background(values.colors.muted)
    shape(values.shapes.lg)
    contentPadding(3f.dp)
}

internal fun shadcnTabStyle(values: UiThemeValues, active: Boolean): Style = Style {
...
internal fun shadcnBreadcrumbItemStyle(values: UiThemeValues, current: Boolean): Style = Style {
    foreground(if (current) values.colors.foreground else values.colors.mutedForeground)
    textSize(values.typography.caption)
}

internal fun shadcnBreadcrumbMutedStyle(values: UiThemeValues): Style =
