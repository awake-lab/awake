...
internal fun shadcnSidebarStyle(values: UiThemeValues): Style = Style {
    background(values.colors.card)
    foreground(values.colors.foreground)
    contentPadding(8f.dp)
}

internal fun shadcnSidebarActionStyle(values: UiThemeValues): Style = Style {
...
internal fun shadcnSidebarHeaderBadgeStyle(values: UiThemeValues): Style = Style {
...
internal fun shadcnSidebarAvatarStyle(values: UiThemeValues): Style = Style {
...
internal fun shadcnSidebarTitleStyle(values: UiThemeValues): Style = Style {
    textSize(14f.sp)
    fontWeight(FontWeight.SemiBold)
    foreground(values.colors.foreground)
}

internal fun shadcnSidebarSupportingTextStyle(values: UiThemeValues): Style = Style {
    textSize(11f.sp)
    foreground(values.colors.mutedForeground)
}

internal fun shadcnSidebarGroupLabelStyle(values: UiThemeValues): Style = Style {
    foreground(values.colors.mutedForeground)
    textSize(12f.sp)
...
internal fun shadcnSidebarMenuItemStyle(values: UiThemeValues, active: Boolean): Style = Style {
