...
// body either). Regenerating overwrites this file; checkJniBindings (a manual
// diagnostic task, not wired into the build) can flag signature drift, so re-running
// generateJniBindings after this file has hand-written bodies requires re-merging them
// (see docs/decisions/D10-codegen-derisk-findings.md for the merge approach used).
